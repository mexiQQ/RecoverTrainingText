...
class BertPooler(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        l2_norm = torch.linalg.norm(first_token_tensor, ord=2, dim=1, keepdim=True)
        first_token_tensor = first_token_tensor / l2_norm
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        pooled_output, pooler_dense_input = self.pooler(sequence_output) if self.pooler is not None else None
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        outputs, pooler_dense_input  = self.bert(
            input_ids,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
            position_ids=position_ids,
